        ...
        <section className="text-base">
          ...
          <section className="my-4">
            <p>
              ...
              SEOやメールマーケティングなどのスキルやノウハウが必要になってきます。Zeusなどクレジットカード決済との
              接続なども必要な知識になってきます。
            </p>
          </section>
          <section className="my-4">
            <p>
              ...
              バックエンドを構築しているSIerから仕様を投げられてフロントエンドを組み立ていた20年前と違って、
              モダンな技術スタックを使ってフロントエンドエンジニアがバックエンド処理も書けるようになりました。
            ...
            <p>
              ...
              は作れます。全員が全てができるから「フルスタック」なのです。
              ならば、全てできた上で人と違う何ができるかが勝負です。
            </p>
            <p>コードは力なり、まさに上忍。</p>
          </section>
          <section>
            ...
            <p>
              HTML/CSSだけでWebの仕事ができて飯が食える世界がどこかにあると良いのですが、
              残念ながらそんなお花畑はどこにもありません。
            </p>
            <p>
              あるとする、
              SIerやアフィリエイト業者の下でひたすらHTMLを量産するという、
              クリエイティブからは程遠い仕事です。競争も激しい。
              イバラの道です。だって、下忍ですから。
            </p>
            <p>
              自由に仕事をするには、上忍になるに限ります。
              HTML/CSSなんて当たり前、CMSも対応でき、モダンな技術スタックやAI、
              サービスAPIの活用など新しい技術領域を自分で広げていける。
              そんなフルスタックエンジニアしか生き残れない世界です。
            </p>
            <p className="my-4">
              こう書くと身も蓋もありませんが・・
